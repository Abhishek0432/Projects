 			...
 			<?php 
 				...
 				{ ?>
 					...
 					<tr>
                        ...
                        <td><input style="width: 120px; height: 30px;" type="button" value="Confirm" onclick="window.location='distorderconfirm.php?oid=<?php echo $row['order_id']; ?> & qty=<?php echo $row['qty'];  ?> '"></td>
                        <td><input style="width: 120px; height: 30px;" type="button" value="Cancel" onclick="window.location='distordercancel.php?oid=<?php echo $row['order_id']; ?> & qty=<?php echo $row['qty']; ?> & sar_id=<?php echo $row['saree_id']; ?> '"></td>
 					</tr>
