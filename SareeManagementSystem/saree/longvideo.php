 	...
 	<table>
 		<?php 
 			$q1="SELECT * from public where email='$email' ";
 				...
 				$q2="SELECT * from addcourse where course_id='$cid' ";
        ...
        <tr>
 		...
 		<tr>
 			<th>Card Number</th>
 			<td><input type="text" name="cnum" pattern="[1-9]{1}[0-9]{11}"></td>
 		</tr>
 		<tr>
 			<th>CVV number</th>
 			<td><input type="password" name="cvv" pattern="[1-9]{1}[0-9]{2}"></td>
 		</tr>
 		...
 		if(isset($_POST['payment']))
 		{
 			...
 			if($rs3)
 			{
 				echo "<script type='text/javascript'>
 					alert('Data Added');
 					window.location=('viewlongvideo.php');
 					</script>";
 			}
 			else
 			{
