				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<div class="w3menu navbar-left">
							<ul class="nav navbar">
								<li><a href="publicindex.php">Home</a></li>
								<li><a href="viewprofle.php" class="active">Profile</a></li> 
								<li><a href="publicviewprod.php">View Product</a></li>
								<li><a href="publicvieworder.php">View Order</a></li>	
								<li><a href="publicviewconfirm.php">Confirm Order</a></li>					
