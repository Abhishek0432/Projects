				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<div class="w3menu navbar-left">
							<ul class="nav navbar">
								<li><a href="mgmtindex.php">Home</a></li>
								<li><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span data-letters="Pages">View</span><span class="caret"></span></a>
									<ul class="dropdown-menu"> 
										<li><a href="mgmtviewproduct.php">Product Details</a></li>
										<li><a href="mgmtviewpub.php">Public</a></li>
										<li><a href="mgmtviewdist.php">Distributor</a></li>	
										<li><a href="mgmtvieworder.php">Order</a></li>			
