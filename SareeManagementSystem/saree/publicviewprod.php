 ...
 <body>
 	<center>
 		...
 		<table border="1px collapse">
 			...
 			<?php 
 				$q1="SELECT * from products where user='public'";
 				...
 				{ ?>
 					...
 					<tr>
                        ...
                        <td><input type="button" name="addcart" value="Select Quantity" onclick="window.location='pubaddcart.php?id=<?php echo $row['pid']; ?>'" ></td>
