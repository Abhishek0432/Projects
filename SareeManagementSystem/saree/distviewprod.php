 ...
 <body>
 	<center>
 		...
 		<table border="1px collapse">
 			...
 			<?php 
 				$q1="SELECT * from products where user='dist' and qty >= '10' ";
 				...
 				{ ?>
 					...
 					<tr>
                        ...
                        <td><input type="button" name="addcart" value="Select Quantity" onclick="window.location='distaddcart.php?id=<?php echo $row['pid']; ?>'" ></td>
